...
var defaultOnScroll = function defaultOnScroll() {
  return null;
};
...
var Grid = function (_PureComponent) {
  ...
  function Grid(props, context) {
    ...
    _this._onThrottledWheel = throttle(_this._onWheelHandler, 1000 / 60);
  ...
  _createClass(Grid, [{
    ...
    value: function _onScroll(event) {
      ...
      var _props9 = this.props,
          autoHeight = _props9.autoHeight,
          autoWidth = _props9.autoWidth,
